...
export default async function adminRoutes(fastify: FastifyInstance) {
  ...
  fastify.route({ method: "POST", url: "/admin/agents", schema: createAgentValidationSchema, preHandler: adminAuthMiddleware, handler: create });
  fastify.route({ method: "PUT", url: "/admin/agents/:id", schema: updateAgentValidationSchema, preHandler: adminAuthMiddleware, handler: update, });
